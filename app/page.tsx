      ...
      <div className="grid h-screen w-screen grid-cols-3 grid-rows-10 gap-3">
        <div className="flex w-screen items-center justify-between">
          <div className="mt-5 ml-5 flex items-center">
            ...
            <h1 className="ml-5 text-6xl font-bold">Hourglass</h1>
          </div>
          <div className="mt-5 mr-5 rounded-4xl bg-[#4FBBC9] p-3">
            <svg
              width="30"
              height="30"
              viewBox="0 0 15 15"
        ...
        <div className="row-start-4 row-end-10 mr-auto ml-auto w-3/4 rounded-sm bg-[#4FBBC9] p-5 text-center">
          <svg
